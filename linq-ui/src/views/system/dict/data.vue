  ...
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" :inline="true">
      ...
      <el-form-item label="字典标签" prop="dictLabel">
        <el-input v-model="queryParams.dictLabel" placeholder="请输入字典标签" clearable size="mini"
    ...
    <el-table v-loading="loading" :data="dataList" @selection-change="handleSelectionChange" size="mini" :height="tableHeight">
...
export default {
  ...
  methods: {
    ...
    getList () {
      this.loading = true
      listData(this.pageNum, this.pageSize, this.queryParams).then(response => {
